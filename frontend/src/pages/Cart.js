...
export default function Cart({cartItems , setCartItems}){
   ...
   function placeOrderHandler(){
    ...
    return cartItems.length>0 ? <Fragment>
                ...
                <h2 className="mt-5">Your Cart: <b>{cartItems.length} item</b></h2>
            ...
            </Fragment> : (!complete ? <h2 className="mt-5">Your Cart is Empty!!!</h2> : <Fragment><h2 className="mt-5">Order Complete!</h2><p>Your Order has been Placed Sucessfully!!!</p></Fragment>)
